...
+function(a) {
	...
	d.VERSION = "3.3.5", d.TRANSITION_DURATION = 150, d.prototype.close = function(
			b) {
		function c() {
		...
		return a.fn.button = d, this
			...
			function(c) {
				...
				d.hasClass("btn") || (d = d.closest(".btn")), b.call(d,
						"toggle"), a(c.target).is('input[type="radio"]')
	...
	c.VERSION = "3.3.5", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
		...
		return this.$element.trigger(g), g.isDefaultPrevented() ? void 0 : (f
				.removeClass("in"), a.support.transition && f.hasClass("fade")
