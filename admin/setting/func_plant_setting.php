...
function getUser($size) {
	...
	$sql="select onchba_sn,onchba_cycle,onchba_size,CAST(onchba_tsize AS DECIMAL(9,1)) as onchba_tsize from online_change_basin where onchba_status > 0 and onchba_size like '{$size}' order by onchba_size, onchba_tsize";
