						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">換盆/下種 日期&nbsp;</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label for="addModalInput1" class="col-sm-2 control-label" >換盆/下種 數量<font color="red">*</font></label>
										<div class="col-sm-10">
						...
						<tbody>
							...
							foreach ($user_list as $row) {
								echo '<tr>';
        							...
        							echo '<td><button type="button" class="btn btn-primary btn-xs upd" data-onadd_sn="'.$row['onadd_sn'].'">執行</button>&nbsp;';
        							echo '</td></tr>';
        						}
        						?>
        					</tbody>
